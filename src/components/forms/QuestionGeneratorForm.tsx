      ...
      {isReviewMode ? (
        <div style={styles.workspace}>
          <div style={styles.workspaceHeader}>
            ...
            <p style={styles.workspaceSubtitle}>
              Review the {draftQuestions.length} draft questions generated by AI. You can edit text, options, and expected answers, remove questions, or add custom ones before saving.
            </p>
          </div>
        ...
        <form onSubmit={handleGenerate} style={styles.form}>
          ...
          {(generating || (progress > 0 && progress < 100)) && (
            <div style={styles.progressContainer}>
              <div style={styles.progressText}>
                Generating {count} questions using AI model... {progress}%
              </div>
          ...
          <Button type="submit" loading={generating} style={{ width: "100%", marginTop: "1rem" }}>
            {generating ? "Running AI Pipeline..." : "Generate AI Questions"}
          </Button>
        </form>
      )}
